...
describe('buildWatchlist', () => {
  it('filters illiquid names and ranks by composite score', () => {
    const inputs: FactorInput[] = [
      { symbol: 'A', tradingValue: 5e9, momentum: 0.5, pbr: 0.8, per: 5, roe: 0.2, eventScore: 0.3 },
      { symbol: 'B', tradingValue: 5e9, momentum: -0.2, pbr: 3, per: 40, roe: 0.02, eventScore: -0.1 },
      { symbol: 'C', tradingValue: 1e6, momentum: 0.9, pbr: 0.5, per: 3, roe: 0.4, eventScore: 0.9 }, // illiquid
    ];
